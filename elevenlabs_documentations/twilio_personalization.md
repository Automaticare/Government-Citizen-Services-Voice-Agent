...
<Steps>
  <Step title="Configure webhook details">
    ...
    <Frame background="subtle">
      ![Enable webhook](file:429cbeb7-1c71-4549-9f50-3d91f210ba30)
    </Frame>

    Click on the webhook to modify which secrets are sent in the headers.

    <Frame background="subtle">
      ![Add secrets to headers](file:3b662d21-5c10-4e0f-9755-0aa05803f559)
    </Frame>
  </Step>
  ...
  <Step title="Enable fetching conversation initiation data">
    ...
    <Frame background="subtle">
      ![Enable webhook](file:2fe7cf4d-6493-4c19-8191-07e3edb4c991)
    </Frame>
  </Step>
