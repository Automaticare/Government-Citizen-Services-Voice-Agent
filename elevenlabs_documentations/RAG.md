...
<Steps>
  <Step title="Enable RAG for your agent">
    ...
    <Frame background="subtle">
      <img src="file:b52ecfe5-d591-42ab-a49a-cbbae60cfb54" alt="Toggle switch to enable RAG in the agent settings" />
    </Frame>
  </Step>
  ...
  <Step title="Configure RAG settings (optional)">
    ...
    * **Maximum vector distance**: Set the maximum distance between the query and the retrieved chunks
    ...
    <Frame background="subtle">
      <img src="file:c1acc74b-0f24-416d-8bfd-1fb7deddff56" alt="RAG configuration options including embedding model selection" />
    </Frame>
  </Step>
  ...
  <Step title="Configure document usage modes (optional)">
    ...
    * **Prompt**: The document is always included in the system prompt, regardless of relevance, but can also be retrieved by RAG
    ...
    <Frame background="subtle">
      <img src="file:07f195f8-18bd-414e-9926-6878cb8a284e" alt="Document usage mode options in the knowledge base" />
    </Frame>
