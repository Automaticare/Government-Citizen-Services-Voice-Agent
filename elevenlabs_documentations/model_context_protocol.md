...
2. Navigate to the [MCP server integrations dashboard](https://elevenlabs.io/app/agents/integrations) and click "Add Custom MCP Server".
   ...
   <Frame background="subtle">
     ![Creating your first MCP server](file:151c0228-8ccd-4aa2-8044-4f416ff10052)
   </Frame>
...
4. Click "Add Integration" to save the integration and test the connection to list available tools.
   ...
   <Frame background="subtle">
     ![Zapier example tools](file:634c8ea0-7510-472e-965a-098f39dcf90e)
   </Frame>

5. The MCP server is now available to add to your agents. MCP support is available for both public and private agents.

   <Frame background="subtle">
     ![Adding the MCP server to an agent](file:89020607-a41e-4323-b4f4-a912caa7cb4f)
   </Frame>
...
<Frame background="subtle">
  ![Tool approval mode settings](file:895e3c25-aa35-4874-8c02-031db64904b3)
</Frame>
...
<Frame background="subtle">
  ...
  settings](file:ba0ca42f-fe02-4fe1-9100-ddd344fa3506)
</Frame>
