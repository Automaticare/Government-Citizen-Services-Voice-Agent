...
<Steps>
  <Step title="Define dynamic variables in prompts">
    ...
    * Tool parameters
    ...
    <Frame background="subtle">
      ![Dynamic variables in messages](file:fd0b9ebf-6718-4569-8b33-e737e2ffc009)
    </Frame>

    <Frame background="subtle">
      ![Dynamic variables in messages](file:d5b42313-aa7e-4c22-9cc6-abc8d2232acb)
    </Frame>
  </Step>
  ...
  <Step title="Define dynamic variables in tools">
    ...
    <Frame background="subtle">
      ![Setting placeholders](file:27e37a81-095a-46d5-b98f-98e6babfcfba)
    </Frame>

    <Frame background="subtle">
      ![Setting placeholders](file:b36d612a-88b4-4851-b503-02b89acf5992)
    </Frame>
  </Step>
  ...
  <Step title="Set placeholders">
    ...
    <Frame background="subtle">
      ![Setting placeholders](file:63c5c40a-2b7f-4a47-aac3-dc6ddbd01f9c)
    </Frame>
  </Step>
